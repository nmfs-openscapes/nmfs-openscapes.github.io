...
-   **3 approaches for the year of open science** ([post](https://nmfs-openscapes.github.io/blog/2023-03-16-esip-winter-2023)). Summary of a conference panel with Openscapes Mentors from NOAA Fisheries, California Water Boards, NASA’s National Snow and Ice Data Center, and NASA’s Physical Oceanography Distributed Active Archive Center, and University of North Carolina.
-   **NOAA Fisheries invests in Open Science Mentorship**. Report out on the first NMFS Mentor workshops with Openscapes ([post](https://nmfs-openscapes.github.io/blog/2024-01-24-nmfs-mentors))
-   **Exciting Progress for Research Teams using NASA Earthdata in the Cloud**: 2023 NASA Openscapes Champions Wrap-up ([post](https://openscapes.org/blog/2023-08-01-nasa-champions))
-   **California Water Boards’ 2nd Annual Openscapes Champions Program** - Reflections & Future ([post](https://openscapes.org/blog/2023-12-13-waterboards))
-   **2024 Pathways to Open Science Program** - in collaboration with PREreview ([post](https://openscapes.org/blog/2024-01-22-pathways-2024/)). Building community for Black environmental and marine scientists and HBCU students.
-   **On-ramp to Open Science at the Fred Hutch Cancer Center**. 2023 Fred Hutch Openscapes Champions Wrap-up ([post](https://openscapes.org/blog/2023-12-04-fred-hutch))
