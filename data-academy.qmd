...
Due to the high level of interest, we plan to hold 3 additional cohorts in the next 12 months for other R learners. The [Data Academy cohorts 2025](https://docs.google.com/document/d/1iQY1JpUZ9Ku2xF_Qb3jwxrCqFFAGYXn0_VqECOOEM3Q/) doc outlines the plan for each cohort. 
...
The Spring Cohort has been designed for absolute beginners to R, and will cover the basics of R programming and data visualization. This is a great opportunity for those who are new to R or have limited experience with it.
...
**Who**: FTEs and Affiliates from any Fisheries office are welcome to sign up. The *40 (80) available spots will be distributed across centers and offices.
...
::: {.callout-note}
*Due to high demand, we ran the equivalent of two cohorts simultaneously in Spring 2025, for a total of ~80 participants. The [second cohort](#fall-2025-cohort) in the Fall will be for those with some R experience, and will be more self-directed.
:::
...
Participants in the Data Academy Spring Cohort will complete two Skill Paths (view as [weekly spreadsheet](https://docs.google.com/spreadsheets/d/1CVpthda3gOVT57nTOfdXjXuAr0vwc5k7avQtDJu-K8I)):
...
Particpants for the Fall cohort will be selected from the waitlist of the Spring cohort.
