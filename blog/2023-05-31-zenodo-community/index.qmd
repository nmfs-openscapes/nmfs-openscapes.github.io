...
![](zenodo-openscapes-community.png){fig-alt="screenshot of the Openscapes Community page on Zenodo" fig-align="center" width="70%"}
...
![Associating a Zenodo record with an author's ORCID ID results in that record being automatically listed in their ORCID profile.](zenodo-orcid.png){fig-alt="screenshot showing zenodo record called 3 Approaches for the Year of Open Science with green ID symbol linked with an arrow to a second screenshot showing the ORCID record for that publication" fig-align="center" width="50%"}
