...
::: grid
::: g-col-3
![](images/zoomie2-2024-nmfs-champions-a.png){fig-alt="headshots in zoom meeting. a 7 by 6 grid of people smiling and waving"}
:::
::: g-col-3
insert cohort b zoomie here
:::
::: g-col-3
![](images/zoomie-2024-nmfs-champions-c.png){fig-alt="headshots in zoom meeting. a 6 by 6 grid of people smiling and waving"}
:::
:::
...
Champions learned from stories shared by past participants including the Alaska Marine Mammal Stock Assessment Report process ([recording](https://www.youtube.com/watch?v=wqbwcCXbFL8)) and the California Current Ecosystem Status Report Automation team ([recording](https://youtu.be/St_j0D-u7UU)). [Mentors from across NMFS](../mentors/index.qmd) attended some Cohort Calls and Coworking sessions to share their expertise and experience.
