...
There were 194 total signups for 120 seats (fantastic!). There is no one perfect way to select people for those spots. We selected the Cohorts with transparent decision criteria that were developed with the Mentors, Eli Holmes, and the Openscapes team.
